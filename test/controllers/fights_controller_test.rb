...
class FightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fight" do
    assert_difference('Fight.count') do
      post fights_url, params: { fight: { fight_history: @fight.fight_history, first_fighter: @fight.first_fighter, loser: @fight.loser, second_fighter: @fight.second_fighter, winner: @fight.winner } }
    end
  ...
  test "should update fight" do
    patch fight_url(@fight), params: { fight: { fight_history: @fight.fight_history, first_fighter: @fight.first_fighter, loser: @fight.loser, second_fighter: @fight.second_fighter, winner: @fight.winner } }
